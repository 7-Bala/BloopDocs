...
const SUPPORTED_NODES: FormatNode[] = [
  ...
  { ext: "PAGES", name: "Apple Pages", desc: "Rich typography, nested column layouts, custom media frames, and canvas grids.", brand: "Pages", speed: "18ms", fidelity: "99.9%", nativeColor: "#F98D29" },
  ...
  { ext: "NUMBERS", name: "Apple Numbers", desc: "Canvas layout sheets, independent tables, vector chart data, and formula parsing.", brand: "Numbers", speed: "16ms", fidelity: "99.8%", nativeColor: "#34C759" },
  ...
  { ext: "KEY", name: "Apple Keynote", desc: "Cinematic slide grids, absolute coordinate bounding boxes, and grouped shape transformations.", brand: "Keynote", speed: "20ms", fidelity: "99.9%", nativeColor: "#007AFF" },
